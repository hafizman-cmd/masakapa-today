...
export const ingredientOptions = [
  ...
  { id: 'fish', name: bilingual('Ikan merah', 'Red snapper'), group: 'Seafood' },
  ...
  { id: 'siakap', name: bilingual('Ikan Siakap', 'Sea bass'), group: 'Seafood' },
  { id: 'ikan-siakap', name: bilingual('Ikan Siakap', 'Sea bass'), group: 'Seafood' },
  { id: 'ikan-kerapu', name: bilingual('Ikan Kerapu', 'Grouper'), group: 'Seafood' },
  { id: 'ikan-merah', name: bilingual('Ikan Merah', 'Red snapper'), group: 'Seafood' },
  { id: 'ikan-jenahak', name: bilingual('Ikan Jenahak', 'Golden snapper'), group: 'Seafood' },
  { id: 'ikan-bawal', name: bilingual('Ikan Bawal', 'Pomfret'), group: 'Seafood' },
  { id: 'ikan-tongkol', name: bilingual('Ikan Tongkol', 'Tuna'), group: 'Seafood' },
  { id: 'ikan-senangin', name: bilingual('Ikan Senangin', 'Threadfin'), group: 'Seafood' },
  { id: 'ikan-haruan', name: bilingual('Ikan Haruan', 'Snakehead fish'), group: 'Seafood' },
  { id: 'ikan-terubuk', name: bilingual('Ikan Terubuk', 'Herring'), group: 'Seafood' },
  { id: 'stingray', name: bilingual('Ikan Pari', 'Stingray'), group: 'Seafood' },
  { id: 'tilapia', name: bilingual('Ikan Tilapia', 'Tilapia'), group: 'Seafood' },
  { id: 'cencaru', name: bilingual('Ikan Cencaru', 'Scad'), group: 'Seafood' },
  { id: 'mackerel', name: bilingual('Ikan Kembung', 'Mackerel'), group: 'Seafood' },
  ...
  { id: 'salted-fish', name: bilingual('Ikan Masin', 'Salted fish'), group: 'Seafood' },
  ...
  { id: 'ikan-tenggiri', name: bilingual('Ikan Tenggiri', 'Spanish mackerel'), group: 'Seafood' },
